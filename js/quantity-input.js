...
$('.gty-container').each(function () {
    ...
    $('input[name="Number_of_Adults"]', parent).change(function () {
    ...
    $('input[name="Number_of_Adults"]', parent).trigger('change');

    // Children quantity number
    $('input[name="Number_of_Childrens"]', parent).change(function () {
    ...
    $('input[name="Number_of_Childrens"]', parent).trigger('change');
