                        ...
                        <div class="card-item room-card">
                            ...
                            <div class="card-body">
                                <div class="card-price pb-2">
                                    <p>
                                        <span class="price__from" style="color:#f6da86">From</span>
                                        <span class="price__num" style="color:#f6da86"><?php echo "Rs.".number_format($room['Single_Person_Charge'], 2);?></span>
                                    </p>
                                </div>
                                <h3 class="card-title font-size-26" style="color:#f6da86"><a href="room-details.php"><?php echo $room['Room_Type_Name'];?></a></h3>
