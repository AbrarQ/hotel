                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white">Edit Room</h2>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-box">
                            <div class="form-title-wrap">
                                <h3 class="title">Edit Room</h3>
                            </div>
                            <div class="form-content">
                                <div class="contact-form-action">
                                     <form action="<?php echo base_url().'index.php/Admin/updateRoom'?>" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-2 responsive-column">
											 <label class="label-text" style="margin-top: 10px;float: right; font-weight: 600">Room Type Name</label>
											</div>
                                                ...
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                       <input type="hidden" name="Room_Type_ID" value="<?php echo $room->Room_Type_ID;?>">
                                                        <input class="form-control" name="Room_Type_Name" value="<?php echo $room->Room_Type_Name;?>" type="text" placeholder="Room Type">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-12 -->
											</div>
                                            ...
                                            <div class="col-lg-6 responsive-column">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="Number_of_Adults"  value="<?php echo $room->Number_of_Adults;?>" type="text" placeholder="No.of Adults">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-12 -->
											</div>
                                            ...
                                            <div class="col-lg-6 responsive-column">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="Number_of_Childrens"  value="<?php echo $room->Number_of_Childrens;?>" type="text" placeholder="No.of Childrens">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-12 -->
											</div>
                                            ...
                                            <div class="col-lg-6 responsive-column">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="Room_Price" type="text" value="<?php echo $room->Room_Price;?>" placeholder="Room Price">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-12 -->
											</div>
                                            ...
                                            <div class="col-lg-6 responsive-column">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                       <textarea class="form-control" name="Room_Description"><?php echo $room->Room_Description;?></textarea>
                                            ...
                                            <div class="col-lg-2 responsive-column">
											 <label class="label-text" style="margin-top: 10px;float: right; font-weight: 600">Room Status</label>
											</div>
                                            <div class="col-lg-6 responsive-column">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                       <select class="form-control" name="Room_Type_Status">
														<option <?php if($room->Room_Type_Status=="ACTIVE"){ echo "Selected";}?> value="ACTIVE">ACTIVE</option>
														<option <?php if($room->Room_Type_Status=="BOOKED"){ echo "Selected";}?> value="BOOKED">BOOKED</option>
														<option <?php if($room->Room_Type_Status=="DEACTIVE"){ echo "Selected";}?> value="DEACTIVE">DEACTIVE</option>
													   </select>
                                            ...
                                            <div class="col-lg-6 responsive-column">
											 ...
											 foreach($roomImages as $images){
												?>
											<img src="<?php echo $images['Room_Image'];?>" height="200px" width="200px" style="border: 1px solid #ccc; margin: 10px;padding: 10px;">
