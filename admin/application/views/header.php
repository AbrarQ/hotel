    ...
    <div class="sidebar-nav-body">
        ...
        <div class="author-content">
            <div class="d-flex align-items-center">
                ...
                <div class="author-bio">
                    <h4 class="author__title">Alexander Luxury Hotel</h4>
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                <li class="page-active"><a href="<?php echo base_url().'index.php/Admin';?>"><i class="la la-dashboard mr-2"></i>Dashboard</a></li>
                <li><a href="<?php echo base_url().'index.php/Admin/bookings';?>"><i class="la la-shopping-cart mr-2 text-color"></i>Bookings</a></li>
                <li>
                    <span class="side-menu-icon toggle-menu-icon">
                        <i class="la la-angle-down"></i>
                    </span>
                    <a href="#"><i class="la la-list mr-2 text-color-2"></i>Manage Rooms</a>
                    <ul class="toggle-drop-menu">
                        <li><a href="<?php echo base_url().'index.php/Admin/addRoom';?>">Add Room</a></li>
                        <li><a href="<?php echo base_url().'index.php/Admin/room';?>">Rooms List</a></li>
                    </ul>
                </li>
                
			
                <li><a href="<?php echo base_url().'index.php/Login/logout';?>"><i class="la la-power-off mr-2 text-color-11"></i>Logout</a></li>
            </ul>
